...
mailaddr = 'imap.qq.com' #发送邮件地址
smtpaddr = 'smtp.qq.com' #接收邮件smtp地址
port = 465 #接收SMTP地址端口
usr = '1004988238@qq.com' #接收邮件的邮箱地址
passwd = 'gfxbgninalhlbfdh' #接收邮件的邮箱地址密码
sender = 'diablocpvip@gmail.com' #发送邮件邮箱
